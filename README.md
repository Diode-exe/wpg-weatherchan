...
This uses 'ECData' from env_canada to get the weather data from Environment Canada. It can be found at [env_canada](https://github.com/michaeldavie/env_canada).
...
This code is available under the terms of the [MIT License](https://opensource.org/licenses/MIT).
